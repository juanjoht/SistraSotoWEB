...
export class VehicleBasicEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formGroupBasic = this.formBuilder.group({
      ...
      capacityM3:['0',[Validators.required]],
      capacityTon:['0', [Validators.required]],
    ...
    }else
    {
      this.formGroupBasic = this.formBuilder.group({
        ...
        capacityM3:[{value: this.vehicleEdit.capacityM3, disabled: this.viewMode},[Validators.required]],
